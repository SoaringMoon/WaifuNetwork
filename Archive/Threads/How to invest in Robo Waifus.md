...
Maybe consider training it on vido from your cars driving (outside). I recall people training a system by driving around on bikes with cameras, while following the trafic rules, then using this as data.
