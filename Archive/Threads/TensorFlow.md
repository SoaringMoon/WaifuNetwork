...
Next issue would be, that the GPT approach has always been critizised, and now it seems to be done: 
...
I kind of think it's the other way around, but that aside the whole point of donating compute is that each of us bear a small(ish) part of the hardware and electricity costs. Together if there are enough of us doing that can represent a total system far larger than any of us individually is likely to afford.
