...
```solenoid_force = (turns*current)**2 * 4*3.141592653589793*10**-7 * cross_section_area/(2 * length**2)```
...
this is so key it should be added as a guideline in our Codex %%or whatever we are putting together for that purpose %%
